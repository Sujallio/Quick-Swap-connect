  ...
  <div className="min-h-screen flex flex-col">
    ...
    <div className="flex-1 px-4 pb-24 max-w-lg mx-auto">
      ...
      <div className="prose prose-sm text-muted-foreground space-y-4 text-sm leading-relaxed">
        ...
        <p>For privacy-related queries, reach us at <a href="mailto:support.quickswap24@gmail.com" className="text-primary hover:underline">support.quickswap24@gmail.com</a></p>
      </div>
    </div>
    <Footer />
  </div>
