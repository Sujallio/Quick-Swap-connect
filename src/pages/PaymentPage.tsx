...
// Static UPI QR image - you can replace with your actual QR code
const UPI_QR_IMAGE = "https://via.placeholder.com/300x300?text=UPI+QR+Code";
const UPI_ID = "yourname@upi"; // Update with your actual UPI ID
