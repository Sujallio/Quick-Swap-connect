  ...
  <div className="min-h-screen flex flex-col">
    ...
    <div className="flex-1 px-4 pb-24 max-w-lg mx-auto">
      ...
      <div className="prose prose-sm text-muted-foreground space-y-4 text-sm leading-relaxed">
        ...
        <p>The platform charges a non-refundable posting fee based on the amount: ₹5 for every ₹5000 range. Examples: ₹100–₹5000 = ₹5, ₹5001–₹10000 = ₹10, ₹10001–₹15000 = ₹15, and so on. Contact unlock fee is ₹5. These fees are for platform services.</p>
